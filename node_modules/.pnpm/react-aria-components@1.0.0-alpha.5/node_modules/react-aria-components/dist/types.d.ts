...
import { SelectionBehavior, SelectionMode, ItemProps as _ItemProps1, SectionProps as _SectionProps1, CalendarState, RangeCalendarState, ValidationState, DraggableCollectionState, DraggableCollectionStateOptions, DroppableCollectionState, DroppableCollectionStateOptions, ListState, Orientation, OverlayTriggerProps, OverlayTriggerState, DateFieldState, DateSegmentType, DateSegment as _DateSegment1, DatePickerState, DateRangePickerState, MenuTriggerProps as _MenuTriggerProps1, NumberFieldState, SearchFieldState, SliderState, DisabledBehavior, SortDirection, TooltipTriggerProps } from "react-stately";
...
export const FileTriggerContext: React.Context<ContextValue<FileTriggerProps, HTMLDivElement>>;
/**
 * A FileTrigger allows a user to access the file system with either a Button or Link.
 */
export const FileTrigger: React.ForwardRefExoticComponent<FileTriggerProps & React.RefAttributes<HTMLDivElement>>;
