  ...
  return (
    <>
      <div className="flex items-center justify-between">
        <h1 className="text-3xl">alunos</h1>
        <Link to="/aluno/create" className="p-2 mt-2 text-stone-200 w-fit bg-zinc-900 hover:bg-zinc-700">+ adicionar</Link>
      </div>
                  ...
                  {students.map((student) => (
                    <tr key={student.id} className="border-b dark:border-stone-200">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <Link to={`/aluno/${student.id}`} className="underline">detalhes</Link>
                      </td>
                    </tr>
                  ))}
                </tbody>
  ...
  return (
    <>
      <div className="flex items-center justify-between mb-5">
        ...
        <Link to="/aluno" className="p-2 mt-2 text-stone-200 w-fit bg-zinc-900 hover:bg-zinc-700">voltar</Link>
      </div>
